              ...
              <form class="theme-form login-form" method="post" action="./login.do">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group"><span class="input-group-text"><i class="icon-user"></i></span>
                    <input class="form-control" id="inputId" type="text" name="id" required="" placeholder="ID">
                  </div>
                </div>
                <div class="form-group">
                  <label>Password</label>
                  <div class="input-group"><span class="input-group-text"><i class="icon-lock"></i></span>
                    <input class="form-control" id="inputPw" type="password" name="pw" required="" placeholder="*********">
                    <div class="show-hide"><span class="show">                         </span></div>
                  </div>
                </div>
             
                <div class="form-group">
                  <input class="btn btn-success" type="submit" value="Submit" data-bs-toggle="tooltip"  onclick="loginCheck()" title="btn btn-success">
                </div>
